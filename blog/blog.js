    ...
    const posts = [
        {
            ...
            date: "July 10, 2024",
            content: "This is a translation of a presentation I gave the 5th june 2024 at the conference on the Data as a strategic resource in contemporary conflicts of the Raoul-Dandurand Chair In Montreal. 
                ...
                <p>The American company Palantir has a major role in Ukraine. Palantir's MetaConstellation platform enables real-time satellite image data, analysis, and target detection . This platform reduces the processing time from hours to minutes. 
                    In concrete terms, Palantir defines this platform in three parts : 
                    •	Integrate a network of existing satellites,
                    •	 Optimize hundreds of orbital, ground, and airborne sensors, as well as AI models, 
                    •	Enabling users to ask urgent questions from all over the world.</p>
                <p>The American facial recognition company Clearview AI has also offered its tools to more than 1,500 Ukrainian officials, who have used them to identify more than 230,000 Russians on their territory. It has also been used to identify the losses of both sides for propaganda and counterpropaganda purposes. The company's technology is based on a library of face images that now has 40 billion images, an average of five images for every person on the planet.  The founder of Clearview also estimated that he has 2 million images from the social network VKontacte: the main social network in the Russian-speaking world. More generally, face photos come from all over the internet, including social media, news sites, and any other place where a face may appear</p>
                <h3The technical and ethical limits to the use of AI on the Ukrainian battlefield</h3>
